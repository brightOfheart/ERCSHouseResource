...
public class RenReportOrderDetailBean {
    ...
    public static class DataBean {
        ...
        private List<DecorationRunningsInfoShowList> DecorationRunningsInfoShowList;

        public List<DecorationRunningsInfoShowList> getDecorationRunningsInfoShowList() {
            return DecorationRunningsInfoShowList;
        }

        public void setDecorationRunningsInfoShowList(List<DecorationRunningsInfoShowList> decorationRunningsInfoShowList) {
            DecorationRunningsInfoShowList = decorationRunningsInfoShowList;
        }
        ...
        public static class DecorationRunningsInfoShowList {
            /**
             * StyleID : 1
             * ModuleName : 报备
