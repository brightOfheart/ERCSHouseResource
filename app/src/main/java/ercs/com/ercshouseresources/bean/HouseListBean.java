...
public class HouseListBean extends BaseBean {
    ...
    public class DataBean implements Serializable {
        ...
        public void setTradeTypeChildName(String tradeTypeChildName) {
            TradeTypeChildName = tradeTypeChildName;
        }
        ...
        public void setMgtCost(String mgtCost) {
            MgtCost = mgtCost;
        }
        ...
        public void setOwnerNationalityName(String ownerNationalityName) {
            OwnerNationalityName = ownerNationalityName;
        }
        ...
        public void setPresentSituationName(String presentSituationName) {
            PresentSituationName = presentSituationName;
        }
        ...
        public void setPropertyRightTypeName(String propertyRightTypeName) {
            PropertyRightTypeName = propertyRightTypeName;
        }
        ...
        public void setSquareUse(String squareUse) {
            SquareUse = squareUse;
        }
        ...
        public void setVerandaCount(String verandaCount) {
