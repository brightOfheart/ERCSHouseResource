...
public class FinancialOrderDetailBean {
    /**
     * Type : 1
     * Content : 成功
    ...
    public static class DataBean {
        ...
        private List<TimelineShowList> TimelineShowList;

        public List<TimelineShowList> getTimelineShowList() {
            return TimelineShowList;
        }

        public void setTimelineShowList(List<TimelineShowList> timelineShowList) {
        ...
        public static class TimelineShowList {
            /**
             * StyleID : 1
             * ModuleName : 报备
