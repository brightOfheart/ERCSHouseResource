...
public class Ren_OrderReportPhotoGridAdapter extends ViewHolderAdapter<RenReportOrderDetailBean.DataBean.DecorationRunningsInfoShowList.ImageListBean> {
    ...
    public Ren_OrderReportPhotoGridAdapter(Activity context, List<RenReportOrderDetailBean.DataBean.DecorationRunningsInfoShowList.ImageListBean> listData, OrderReportPhotoGridAdapter.OnCancelPhotoListener onCancelPhotoListener) {
    ...
    @Override
    public View buildConvertView(LayoutInflater layoutInflater, RenReportOrderDetailBean.DataBean.DecorationRunningsInfoShowList.ImageListBean picBean, int position) {
        return layoutInflater.inflate(R.layout.item_photo_gridview,null);
    }

    @Override
    public void bindViewDatas(ViewHolder holder, final RenReportOrderDetailBean.DataBean.DecorationRunningsInfoShowList.ImageListBean picBean, final int position) {
