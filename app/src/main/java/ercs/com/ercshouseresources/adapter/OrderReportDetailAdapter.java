...
public class OrderReportDetailAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        final ReportOrderDetailBean.DataBean.NewHouseRunningsInfoShowListBean newHouseRunningsInfoShowListBean = list.get(i);
        ...
        }else if (newHouseRunningsInfoShowListBean.getStyleID()==3)
        {
            ...
            OrderReportPhotoGridAdapter orderReportPhotoGridAdapter=new OrderReportPhotoGridAdapter(context, newHouseRunningsInfoShowListBean.getImageList(), new OrderReportPhotoGridAdapter.OnCancelPhotoListener() {
                @Override
