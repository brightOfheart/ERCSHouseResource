...
public class Ren_OrderReportDetailAdapter extends BaseAdapter {
    private List<RenReportOrderDetailBean.DataBean.DecorationRunningsInfoShowList> list;
    private Activity context;
    private OrderReportDetailAdapter.OnCamreaListener onCamreaListener;


    public Ren_OrderReportDetailAdapter(List<RenReportOrderDetailBean.DataBean.DecorationRunningsInfoShowList> list, Activity context, OrderReportDetailAdapter.OnCamreaListener onCamreaListener) {
        this.list = list;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        final RenReportOrderDetailBean.DataBean.DecorationRunningsInfoShowList newHouseRunningsInfoShowListBean = list.get(i);
        if (newHouseRunningsInfoShowListBean.getStyleID() == 1) {
            ...
            Ren_OrderReportPhotoGridAdapter orderReportPhotoGridAdapter = new Ren_OrderReportPhotoGridAdapter(context, newHouseRunningsInfoShowListBean.getImageList(), new OrderReportPhotoGridAdapter.OnCancelPhotoListener() {
                @Override
