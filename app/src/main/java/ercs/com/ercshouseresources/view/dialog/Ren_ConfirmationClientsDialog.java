...
public class Ren_ConfirmationClientsDialog extends BaseDialog {
    ...
    public Ren_ConfirmationClientsDialog(Activity mActivity, String name, List<CustomersListBean.DataBean.PhoneListBean> tels,String BuildingID,String CustomerID) {
        super(mActivity);
        this.name = name;
        this.tels = tels;
        context=mActivity;
    ...
    public void initView() {
        ...
        tv_sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //确定
                Ren_PrepareInformationActivity.start(context,name,tels.get(confirmationClientsAdapter.getPos()).getPhone(),tels.get(confirmationClientsAdapter.getPos()).getCustomerPhoneID()+"",CustomerID,BuildingID);
                dismiss();
            }
        });
    }
