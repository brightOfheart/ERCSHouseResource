package ercs.com.ercshouseresources.view.lazyviewpager;
...
public abstract class LazyFragmentPagerAdapter extends LazyPagerAdapter<Fragment> {
	...
	public Object instantiateItem(ViewGroup container, int position) {
		...
		if (fragment != null) {
			if (DEBUG)
				Log.v("", "Attaching item #" + itemId + ": f=" + fragment);
	...
	public void destroyItem(ViewGroup container, int position, Object object) {
		...
		if (DEBUG)
			Log.v("", "Detaching item #" + getItemId(position) + ": f=" + object + " v=" + ((Fragment) object).getView());
