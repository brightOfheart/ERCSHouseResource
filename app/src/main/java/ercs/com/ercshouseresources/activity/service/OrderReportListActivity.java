...
public class OrderReportListActivity extends BaseActivity {
    ...
    private void downLoad( int page, final boolean isLoading) {
        if (isLoading)
        loadingDialog.show();
        NetHelperNew.RunningsList(page+"", new HttpUtils.HttpCallback() {
            @Override
    ...
    private void initRecycleView() {
        ...
        orderReportListAdapter = new OrderReportListAdapter(this,dataBeanList);
